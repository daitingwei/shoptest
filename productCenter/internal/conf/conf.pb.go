...
func (x *Registry_Nacos) GetTimeoutMs() int64 {
	if x != nil {
		return x.TimeoutMs
	}
	return 0
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"\xd8\x01\n" +
	"\bRegistry\x120\n" +
	"\x05nacos\x18\x01 \x01(\v2\x1a.kratos.api.Registry.NacosR\x05nacos\x1a\x99\x01\n" +
	"\x05Nacos\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12!\n" +
	"\fnamespace_id\x18\x02 \x01(\tR\vnamespaceId\x12\x1d\n" +
	"\n" +
	"timeout_ms\x18\x03 \x01(\x03R\ttimeoutMs\x12\x17\n" +
	"\alog_dir\x18\x04 \x01(\tR\x06logDir\x12\x1b\n" +
	"\tcache_dir\x18\x05 \x01(\tR\bcacheDirB\"Z productCenter/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Registry_Nacos)(nil),      // 8: kratos.api.Registry.Nacos
